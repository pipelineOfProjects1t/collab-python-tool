...
PROJECT_TITLE = 'Учёт мероприятий'
DATA_FILE = Path(__file__).with_name('events.json')
FIELDS = [{'name': 'title', 'label': 'Название мероприятия', 'type': 'text', 'sample': 'Хакатон'}, {'name': 'date', 'label': 'Дата', 'type': 'text', 'sample': '2026-06-01'}, {'name': 'place', 'label': 'Место', 'type': 'text', 'sample': 'Аудитория 101'}, {'name': 'participants', 'label': 'Количество участников', 'type': 'int', 'sample': 25, 'min': 0}]
GROUP_FIELD = 'place'
NUMERIC_FIELD = 'participants'
NUMERIC_LABEL = 'Общее количество участников'
NUMERIC_MODE = 'sum'
DUPLICATE_FIELDS = ['title', 'date']
SAMPLE_RECORD = {'title': 'Хакатон', 'date': '2026-06-01', 'place': 'Аудитория 101', 'participants': 25}
